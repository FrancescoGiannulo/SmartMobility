...
INSERT INTO mezzi (codice, tipo, stato, lat, lng, batteria) VALUES
  ...
  ('BIC-004', 'bicicletta',  'Disponibile',   41.1150, 16.8870, 100),
  ('BIC-005', 'bicicletta',  'Disponibile',   41.0960, 16.8620, 100),
  ('BIC-006', 'bicicletta',  'In manutenzione', 41.1270, 16.8720, 100),
  ...
  ('AUT-002', 'automobile',  'In uso',         41.1090, 16.8470, 52),
  ('AUT-003', 'automobile',  'Disponibile',   41.1210, 16.8740, 89),
  ('AUT-004', 'automobile',  'Disponibile',   41.0970, 16.8760, 61),
  ('AUT-005', 'automobile',  'In manutenzione', 41.1270, 16.8550, 8),
  ('AUT-006', 'automobile',  'Disponibile',   41.1130, 16.8320, 94),
